  ...
  return (
    <div ref={comingRef} className="pt-[9rem]">
      <div className="flex flex-wrap mb-8 gap-14 rounded-md justify-center items-center">
        <div className="bg-bg-second shadow-xl basis-[75%] md:basis-[50%] lg:basis-[24%] h-[14rem] rounded-lg">
        ...
        <div className="bg-bg-second shadow-xl basis-[75%] md:basis-[50%] lg:basis-[24%] h-[14rem] rounded-lg flex items-center">
        ...
        <div className="bg-bg-second px-4 shadow-xl basis-[75%] md:basis-[50%] lg:basis-[25%] h-[14rem] flex flex-wrap rounded-lg items-center justify-between font-para ">
          <div className="">
